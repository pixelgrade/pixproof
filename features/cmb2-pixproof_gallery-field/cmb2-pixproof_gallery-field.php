...
class Pixproof_CMB2_Field_Pixproof_Gallery {
	...
	public function setup_admin_scripts() {
		wp_register_style( 'pixproof-styles', trailingslashit( PixProofPlugin()->plugin_baseuri ) . 'features/cmb2-pixproof_gallery-field/pixproof_gallery.css' );
		wp_enqueue_style( 'pixproof-styles' );


		wp_enqueue_media();
		wp_register_script( 'proof_pixgallery', trailingslashit( PixProofPlugin()->plugin_baseuri ) . 'features/cmb2-pixproof_gallery-field/pixproof_gallery.js' );
