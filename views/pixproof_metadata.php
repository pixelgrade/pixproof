 ...
 */
?>
	<div id="pixproof_data_<?php echo $post->ID; ?>" class="pixproof-data">
		<div class="grid"><!--
			...
			--><div class="grid__item  one-half  lap-and-up-one-quarter">
				<div class="entry__meta-box">
					...
					<span class="count_photo_selected"></span>
			...
			--><div class="grid__item  one-half  lap-and-up-one-quarter">
				<div class="entry__meta-box">
					<button class="button-download  js-download" onclick="window.open('<?php echo $file; ?>')"><?php esc_html_e( 'Download', 'pixsproof' ); ?></button>
				</div>
			</div><!--
			<?php } ?>
	--></div>
