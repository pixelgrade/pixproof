 ...
 */
class PixproofHTMLTagImpl implements PixproofHTMLTag {
	...
	protected function configure($config = null) {
		$this->attrs = pixproof::instance('PixproofMeta', $config);
	}
	...
	function htmlattributes(array $extra = array()) {
		$attr_segments = array();
		$attributes = pixproof::merge($this->attrs->metadata_array(), $extra);
